  ...
  return (<nav id="sidebar">
    <div className="sidebar-content">
      ...
      <div className="side-content">
        ...
        <li>
            <NavLink activeClassName="active" to="/home/profile"><i className="si si-home"></i><span className="sidebar-mini-hide">Home</span></NavLink>
          </li>
          <li>
            <NavLink activeClassName="active" to="/home/manageProfile"><i className="si si-speedometer"></i><span className="sidebar-mini-hide">Manage Profile</span></NavLink>
          </li>
          <li>
            <NavLink activeClassName="active" to="/home/teams"><i className="si si-user"></i><span className="sidebar-mini-hide">Teams</span></NavLink>
          </li>
          <li>
            <NavLink activeClassName="active" to="/home/manageteams"><i className="si si-speedometer"></i><span className="sidebar-mini-hide">Manage Teams</span></NavLink>
          </li>
        </ul>
      </div>
    </div>
